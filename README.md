...
[![Netlify Deploy button](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=http://github.com/trongnghiango/astro-template-site)
...
Initially created by [onWidget](https://onwidget.com) and maintained by a community of [contributors](http://github.com/trongnghiango/astro-template-site/graphs/contributors).

## License

**AstroWind** is licensed under the MIT license — see the [LICENSE](http://github.com/trongnghiango/astro-template-site/blob/main/LICENSE.md) file for details.
